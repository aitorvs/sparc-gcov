...
extern rtems_event_set t1_finish_event;
...
//        rtems_task_wake_after( 5 * ticks_per_second );
        rtems_task_wake_after( 1000 );
    }


    printf("Task 1 is gone\n");
    // notify that we are exit
//    rtems_event_send( *((rtems_id *)ignored), t1_finish_event  );
